...
public class NonAlcoholicFragment extends Fragment implements CocktailDialog.CocktailDialogListener{

    ListView listView;
    ArrayList<Cocktail> cocktailArrayList = new ArrayList<>();
    private static final String API_URL = "https://www.thecocktaildb.com/api/json/v1/1/filter.php?a=Non_Alcoholic";
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        listView = view.findViewById(R.id.nonAlcoholic_ListView);
    ...
    private void getNonAlcoholicCocktails() {
